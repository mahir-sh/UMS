...
if(isset($_POST['form_login'])) {
    try {
        ...
        $q = $pdo->prepare("SELECT * FROM student WHERE email=?");
...
<div class="container-login">
    <main class="form-signin w-100 m-auto">
        ...
        <form action="" method="post">
            ...
            <p class="mt-3 mb-3 text-center">Don't have an account? <a href="student-registration.php"><button class="btn btn-secondary">Register</button></a></p>
    </main>
